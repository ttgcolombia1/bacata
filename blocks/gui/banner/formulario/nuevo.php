...
$atributos ['ancho'] = '30%';
$atributos ['alto'] = '';
$atributos ['estilo'] = 'campoImagen textoIzquierda ';
//$atributos ['estiloImagen'] = '';
$atributos ['imagen'] = $directorioImagenes.'/logoBacata_banner.png';
...
if(intval($registrosProceso) > 0){
    $tablasProceso['resumen'] = "Procesos electorales creados";
}else{
